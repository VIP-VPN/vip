...
MYIP=$(curl -sS ipv4.icanhazip.com)
Isadmin=$(curl -sS https://raw.githubusercontent.com/RMBL-VIP/permission/main/ipmini | grep $MYIP | awk '{print $5}')
Exp2=$(curl -sS https://raw.githubusercontent.com/RMBL-VIP/permission/main/ipmini | grep $MYIP | awk '{print $3}')
export RED='\033[0;31m'
export GREEN='\033[0;32m'

Name=$(curl -sS https://raw.githubusercontent.com/RMBL-VIP/permission/main/ipmini | grep $MYIP | awk '{print $2}')
...
mkdir /root/rmbl
cd /root/rmbl
wget https://raw.githubusercontent.com/RMBL-VIP/permission/main/ipmini >/dev/null 2>&1
...
wget -q -O /etc/status "https://raw.githubusercontent.com/VIP-VPN/vip/main/status"
...
sleep 2
wget -q -O /root/install_up.sh "https://raw.githubusercontent.com/VIP-VPN/vip/main/menu/install-up.sh" && chmod +x /root/install_up.sh
sleep 2
./install_up.sh
rm /root/install_up.sh
rm /opt/.ver
version_up=$( curl -sS https://raw.githubusercontent.com/RMBL-VIP/permission/main/versi)
...
serverV=$( curl -sS https://raw.githubusercontent.com/VIP-VPN/vip/main/menu/versi)
if [ "$Isadmin" = "ON" ]; then
...
function bannner(){
wget -O /etc/issue.net "https://raw.githubusercontent.com/VPN-VIP/vip/main/install/issue2.net" &> /dev/null
menu
}
echo -e "$COLOR1╔═════════════════════════════════════════════════╗${NC}"
