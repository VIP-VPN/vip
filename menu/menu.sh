...
sleep 2
wget -q -O /root/install_up.sh "https://raw.githubusercontent.com/RMBL-ZERO/ZERO/main/menu/install-up.sh" && chmod +x /root/install_up.sh
sleep 2
./install_up.sh
...
function bannner(){
wget -O /etc/issue.net "https://raw.githubusercontent.com/RMBL-ZERO/ZERO/main/install/issue2.net" &> /dev/null
menu
}
echo -e "$COLOR1╔═════════════════════════════════════════════════╗${NC}"
